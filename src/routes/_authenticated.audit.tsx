              ...
              {q.isLoading ? (
                ...
                (q.data ?? []).map((a) => (
                  <tr key={a.auditId} className="border-b border-border last:border-0">
                    ...
                    <td className="px-4 py-3">
                      {a.actorLabel ?? <span className="text-muted-foreground">system</span>}
                    </td>
                    <td className="px-4 py-3">
                      {a.meta?.name ?? <span className="text-muted-foreground">-</span>}
                    </td>
                    <td className="px-4 py-3">
                      {a.meta?.email ?? <span className="text-muted-foreground">-</span>}
                    </td>
                    <td className="px-4 py-3">
                      {a.meta?.phone ?? <span className="text-muted-foreground">-</span>}
                    </td>
